...
export default function TeamApprovalsAttendancePage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setRequests(corrections.filter((c) => ids.has(c.employeeId)));
      setEmployeeOptions(
        result.items
      ...
      setError("We couldn't load attendance corrections.");
    } finally {
      setIsLoading(false);
    }
  }, [user?.id]);
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-app-muted mt-1">
          Record check-in/out corrections for your team — no approval required
        </p>
      </div>
      ...
      <Tabs
        tabs={[
          ...
          { id: "history", label: "History", count: requests.length },
        ]}
        activeTab={activeTab}
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="Your team's attendance corrections will appear here"
        />
      ) : (
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-app-muted">
                        ...
                        {format(parseISO(req.date), "EEE, dd MMM yyyy")}
                      </p>
                    </div>
